...
export default function (injectDeps, {FlowRouter, _, DocHead, Meteor}) {
  ...
  FlowRouter.route('/', {
    ...
    action() {
      ...
      DocHead.addMeta({name: 'twitter:images', content: Meteor.absoluteUrl('image/logo.png')});
      ...
      DocHead.addMeta({property: 'og:image', content: Meteor.absoluteUrl('image/logo.png')});
